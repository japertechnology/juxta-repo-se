...
[**.github/workflows/juxta-repo-cleanup**](.github/workflows/juxta-repo-cleanup.yml) renames `README.md` to `HELP.md`, `SETTINGS.md` to `README.md` and the `LICENSE.md1` and `repository/` directory are deleted.
